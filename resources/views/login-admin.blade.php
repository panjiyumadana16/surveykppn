...
<head>
  ...
  <title>Aplikasi Survey KPPN Kediri | Log in Admin</title>
...
<body class="hold-transition">
    ...
    @endif
<div class="login-box container-fluid my-3">
  <div class="login-logo bg-white rounded">
    <a href="#"><b>Login</b><br>Survey KPPN Kediri</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
    <div class="login-logo">
        <img class="container" src="dist/img/Logo.png" style="width: 35%;">
    </div>
